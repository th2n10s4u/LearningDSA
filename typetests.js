...
export function typetests() {
  ...
  let num2 = num1;
  console.log(
    `Initial        : zero = ${zero},      num1 = ${num1},         num2 = ${num2}`
  );
  num1 = 1;
  console.log(
    `Modified num1  : zero = ${zero},      num1 = ${num1},         num2 = ${num2}`
  );
  ...
  let numPI2 = numPI;
  console.log(
    `Initial        : PI = ${PI},   numPI = ${numPI},   numPI2 = ${numPI2}`
  );
  numPI = 2.79;
  console.log(
    `Modified numPI : PI = ${PI},   numPI = ${numPI},     numPI2 = ${numPI2}`
  );
  ...
  let bool3 = bool2;
  console.log(
    `Initial        : bool1 = ${bool1},  bool2 = ${bool2},     bool3 = ${bool3}`
  );
  bool2 = false;
  console.log(
    `Modified bool1 : bool1 = ${bool1},  bool2 = ${bool2},    bool3 = ${bool3}`
  );
  ...
  let name2 = name1;
  console.log(
    `Initial        : Tim = ${Tim},     name1 = ${name1},      name2 = ${name2}`
  );
  name1 = "Evelyn";
  console.log(
    `Modified name1 : Tim = ${Tim},     name1 = ${name1},   name2 = ${name2}`
  );

  // Complex Types
  // a. the variable of a complex type points to the memory location of the 'object'
  //    that contains the value(s) of the variable
  //    - assigning the variable (var1) to another variable (var2), eg. var2 = var1;
  ...
  console.log("-----------------------------");
  const odd = [1, 3, 5, 7, 9];
  //   odd = [11]; errors out because it's defined as a constant
  let arr1 = odd;
  let arr2 = arr1;
  let arr3 = [...arr1];
  console.log(
    `Initial        : arr1 = ${arr1},        arr2 = ${arr2},        arr3 = ${arr3}`
  );
  odd.push(11);
  console.log(
    `Modified arr1  : arr1 = [${arr1}]     arr2 = [${arr2}],     arr3 = [${arr3}]`
  );
  console.log(odd);
}
